/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 8a9fd362cd2d37ef55f7dfbf9d7e63ba)
// Runtime types generated with workerd@1.20260811.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	github_action_assistant_db: D1Database;
	AI: Ai;
	ChatAgent: DurableObjectNamespace<import("./src/server").ChatAgent>;
	GITHUB_RUN_WORKFLOW: Workflow<Parameters<import("./src/server").GithubRunWorkflow['run']>[0]['payload']>;
}
